...
var (
	baseSegmentCharacterFormat = map[string]field{
		...
		"SocialSecurityNumber":          {297, 9, numeric, nullable},
		"DateBirth":                     {306, 8, date, nullable},
	...
	baseSegmentPackedFormat = map[string]field{
		...
		"SocialSecurityNumber":          {248, 5, packedNumber, nullable},
		"DateBirth":                     {253, 5, packedDate, nullable},
