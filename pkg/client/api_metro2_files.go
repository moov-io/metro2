...
func (a *Metro2FilesApiService) ConvertExecute(r ApiConvertRequest) (*os.File, *http.Response, error) {
	...
	if r.format2 != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "format", r.format2, "")
	}
	if r.type_ != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "type", r.type_, "")
	}
	if r.generate != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "generate", r.generate, "")
	}
	if r.newline != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "newline", r.newline, "")
	}
